...
class AccountManager:
    ...
    async def create_account(self, api_key: str, account_name: Optional[str] = None) -> SellerAccount:
        """Создание нового кабинета продавца"""
        # Валидация API ключа
        ...
        print(f"✅ Создан новый кабинет: {new_account.account_name or 'Без названия'}")
        return new_account
